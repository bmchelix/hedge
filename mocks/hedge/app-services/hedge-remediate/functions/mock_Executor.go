...
func (_m *MockExecutor) CommandExecutor(ctx interfaces.AppFunctionContext, command models.Command) (bool, models.CommandExecutionLog) {
	...
	var r0 bool
	var r1 models.CommandExecutionLog
	if rf, ok := ret.Get(0).(func(interfaces.AppFunctionContext, models.Command) (bool, models.CommandExecutionLog)); ok {
	...
	if rf, ok := ret.Get(1).(func(interfaces.AppFunctionContext, models.Command) models.CommandExecutionLog); ok {
		r1 = rf(ctx, command)
	} else {
		r1 = ret.Get(1).(models.CommandExecutionLog)
	}
...
func (_c *MockExecutor_CommandExecutor_Call) Run(run func(ctx interfaces.AppFunctionContext, command models.Command)) *MockExecutor_CommandExecutor_Call {
...
func (_c *MockExecutor_CommandExecutor_Call) Return(_a0 bool, _a1 models.CommandExecutionLog) *MockExecutor_CommandExecutor_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockExecutor_CommandExecutor_Call) RunAndReturn(run func(interfaces.AppFunctionContext, models.Command) (bool, models.CommandExecutionLog)) *MockExecutor_CommandExecutor_Call {
	_c.Call.Return(run)
	return _c
}
