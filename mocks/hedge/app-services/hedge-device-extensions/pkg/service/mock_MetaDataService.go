...
func (_m *MockMetaDataService) AddLocation(location models.Location) (map[string]string, errors.HedgeError) {
	...
	var r1 errors.HedgeError
	if rf, ok := ret.Get(0).(func(models.Location) (map[string]string, errors.HedgeError)); ok {
		return rf(location)
	}
	if rf, ok := ret.Get(0).(func(models.Location) map[string]string); ok {
		r0 = rf(location)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(models.Location) errors.HedgeError); ok {
		r1 = rf(location)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.HedgeError)
...
func (_c *MockMetaDataService_AddLocation_Call) RunAndReturn(run func(models.Location) (map[string]string, errors.HedgeError)) *MockMetaDataService_AddLocation_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockMetaDataService) GetAllNodes() ([]models.Node, errors.HedgeError) {
	ret := _m.Called()
	...
	var r0 []models.Node
	var r1 errors.HedgeError
	if rf, ok := ret.Get(0).(func() ([]models.Node, errors.HedgeError)); ok {
		return rf()
	}
...
func (_c *MockMetaDataService_GetAllNodes_Call) Return(_a0 []models.Node, _a1 errors.HedgeError) *MockMetaDataService_GetAllNodes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *MockMetaDataService) GetDevices(query *models.Query) ([]models.DeviceSummary, models.Page, errors.HedgeError) {
	ret := _m.Called(query)
	...
	var r1 models.Page
	var r2 errors.HedgeError
	if rf, ok := ret.Get(0).(func(*models.Query) ([]models.DeviceSummary, models.Page, errors.HedgeError)); ok {
		return rf(query)
	}
	if rf, ok := ret.Get(0).(func(*models.Query) []models.DeviceSummary); ok {
		r0 = rf(query)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*models.Query) models.Page); ok {
		r1 = rf(query)
	} else {
		r1 = ret.Get(1).(models.Page)
	}

	if rf, ok := ret.Get(2).(func(*models.Query) errors.HedgeError); ok {
		r2 = rf(query)
	} else {
		if ret.Get(2) != nil {
			r2 = ret.Get(2).(errors.HedgeError)
...
func (_c *MockMetaDataService_GetDevices_Call) Return(_a0 []models.DeviceSummary, _a1 models.Page, _a2 errors.HedgeError) *MockMetaDataService_GetDevices_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockMetaDataService_GetDevices_Call) RunAndReturn(run func(*models.Query) ([]models.DeviceSummary, models.Page, errors.HedgeError)) *MockMetaDataService_GetDevices_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockMetaDataService) GetLocation(locationId string) (models.Location, errors.HedgeError) {
	...
	var r1 errors.HedgeError
	if rf, ok := ret.Get(0).(func(string) (models.Location, errors.HedgeError)); ok {
...
func (_c *MockMetaDataService_GetLocation_Call) RunAndReturn(run func(string) (models.Location, errors.HedgeError)) *MockMetaDataService_GetLocation_Call {
	_c.Call.Return(run)
	return _c
}
