...
func (_m *MockElasticClientInterface) BuildSearchRequest(luceneQuery string, indexName string) esapi.SearchRequest {
	...
	if rf, ok := ret.Get(0).(func(string, string) esapi.SearchRequest); ok {
...
func (_c *MockElasticClientInterface_BuildSearchRequest_Call) Return(_a0 esapi.SearchRequest) *MockElasticClientInterface_BuildSearchRequest_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockElasticClientInterface_BuildSearchRequest_Call) RunAndReturn(run func(string, string) esapi.SearchRequest) *MockElasticClientInterface_BuildSearchRequest_Call {
	_c.Call.Return(run)
	return _c
}

// ConvertToBMCEvents provides a mock function with given fields: result
func (_m *MockElasticClientInterface) ConvertToBMCEvents(result map[string]interface{}) ([]*models.HedgeEvent, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(map[string]interface{}) ([]*models.HedgeEvent, error)); ok {
		return rf(result)
	}
	if rf, ok := ret.Get(0).(func(map[string]interface{}) []*models.HedgeEvent); ok {
		r0 = rf(result)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockElasticClientInterface_ConvertToBMCEvents_Call) Return(_a0 []*models.HedgeEvent, _a1 error) *MockElasticClientInterface_ConvertToBMCEvents_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockElasticClientInterface_ConvertToBMCEvents_Call) RunAndReturn(run func(map[string]interface{}) ([]*models.HedgeEvent, error)) *MockElasticClientInterface_ConvertToBMCEvents_Call {
	_c.Call.Return(run)
	return _c
}

// ConvertToCommandLogs provides a mock function with given fields: hitResults
func (_m *MockElasticClientInterface) ConvertToCommandLogs(hitResults map[string]interface{}) ([]*models.CommandExecutionLog, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(map[string]interface{}) ([]*models.CommandExecutionLog, error)); ok {
		return rf(hitResults)
	}
	if rf, ok := ret.Get(0).(func(map[string]interface{}) []*models.CommandExecutionLog); ok {
		r0 = rf(hitResults)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockElasticClientInterface_ConvertToCommandLogs_Call) Return(_a0 []*models.CommandExecutionLog, _a1 error) *MockElasticClientInterface_ConvertToCommandLogs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockElasticClientInterface_ConvertToCommandLogs_Call) RunAndReturn(run func(map[string]interface{}) ([]*models.CommandExecutionLog, error)) *MockElasticClientInterface_ConvertToCommandLogs_Call {
	_c.Call.Return(run)
	return _c
}

// Index provides a mock function with given fields: req
func (_m *MockElasticClientInterface) Index(req esapi.IndexRequest) error {
	ret := _m.Called(req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(esapi.IndexRequest) error); ok {
		r0 = rf(req)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockElasticClientInterface_Index_Call) RunAndReturn(run func(esapi.IndexRequest) error) *MockElasticClientInterface_Index_Call {
	_c.Call.Return(run)
	return _c
}

// IndexCommandLog provides a mock function with given fields: remediateAction
func (_m *MockElasticClientInterface) IndexCommandLog(remediateAction *models.CommandExecutionLog) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.CommandExecutionLog) error); ok {
...
func (_c *MockElasticClientInterface_IndexCommandLog_Call) Run(run func(remediateAction *models.CommandExecutionLog)) *MockElasticClientInterface_IndexCommandLog_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*models.CommandExecutionLog))
	})
	return _c
}
...
func (_c *MockElasticClientInterface_IndexCommandLog_Call) RunAndReturn(run func(*models.CommandExecutionLog) error) *MockElasticClientInterface_IndexCommandLog_Call {
	_c.Call.Return(run)
	return _c
}

// IndexEvent provides a mock function with given fields: bmcEvent
func (_m *MockElasticClientInterface) IndexEvent(bmcEvent *models.HedgeEvent) error {
...
func (_c *MockElasticClientInterface_IndexEvent_Call) RunAndReturn(run func(*models.HedgeEvent) error) *MockElasticClientInterface_IndexEvent_Call {
	_c.Call.Return(run)
	return _c
}

// IndexMlPrediction provides a mock function with given fields: mlPrediction
func (_m *MockElasticClientInterface) IndexMlPrediction(mlPrediction *models.MLPrediction) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.MLPrediction) error); ok {
		r0 = rf(mlPrediction)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockElasticClientInterface_IndexMlPrediction_Call) Run(run func(mlPrediction *models.MLPrediction)) *MockElasticClientInterface_IndexMlPrediction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*models.MLPrediction))
	})
	return _c
}
...
func (_c *MockElasticClientInterface_IndexMlPrediction_Call) RunAndReturn(run func(*models.MLPrediction) error) *MockElasticClientInterface_IndexMlPrediction_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockElasticClientInterface) SearchCommandLogs(luceneQuery string) ([]*models.CommandExecutionLog, error) {
	...
	var r0 []*models.CommandExecutionLog
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]*models.CommandExecutionLog, error)); ok {
		return rf(luceneQuery)
	}
	if rf, ok := ret.Get(0).(func(string) []*models.CommandExecutionLog); ok {
		r0 = rf(luceneQuery)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.CommandExecutionLog)
...
func (_c *MockElasticClientInterface_SearchCommandLogs_Call) Return(_a0 []*models.CommandExecutionLog, _a1 error) *MockElasticClientInterface_SearchCommandLogs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockElasticClientInterface_SearchCommandLogs_Call) RunAndReturn(run func(string) ([]*models.CommandExecutionLog, error)) *MockElasticClientInterface_SearchCommandLogs_Call {
	_c.Call.Return(run)
	return _c
}

// SearchEvents provides a mock function with given fields: luceneQuery
func (_m *MockElasticClientInterface) SearchEvents(luceneQuery string) ([]*models.HedgeEvent, error) {
	ret := _m.Called(luceneQuery)
	...
	var r0 []*models.HedgeEvent
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]*models.HedgeEvent, error)); ok {
		return rf(luceneQuery)
	}
	if rf, ok := ret.Get(0).(func(string) []*models.HedgeEvent); ok {
		r0 = rf(luceneQuery)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.HedgeEvent)
...
func (_c *MockElasticClientInterface_SearchEvents_Call) Return(_a0 []*models.HedgeEvent, _a1 error) *MockElasticClientInterface_SearchEvents_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockElasticClientInterface_SearchEvents_Call) RunAndReturn(run func(string) ([]*models.HedgeEvent, error)) *MockElasticClientInterface_SearchEvents_Call {
	_c.Call.Return(run)
	return _c
}
